return {
    ...
    { "NickvanDyke/opencode.nvim",
        keys = {
            { "<leader>oo", function() require("opencode").toggle() end, desc = "AI: Toggle" },
            { "<leader>oa", function() require("opencode").ask("@this: ", { submit = true }) end, mode = { "n", "x" }, desc = "AI: Ask" },
            { "<leader>af", function() require("opencode").ask("@file: ", { submit = true }) end, desc = "AI: Send Whole File" },
            { "<leader>ox", function() require("opencode").select() end, mode = { "n", "x" }, desc = "AI: Actions" },
            { "go", function() return require("opencode").operator("@this ") end, mode = { "n", "x" }, expr = true, desc = "AI: Operator" },
            { "goo", function() return require("opencode").operator("@this ") .. "_" end, expr = true, desc = "AI: Line" },
            { "<C-S-u>", function() require("opencode").command("session.half.page.up") end, mode = { "n", "i" }, desc = "AI: Scroll Up" },
            { "<C-S-d>", function() require("opencode").command("session.half.page.down") end, mode = { "n", "i" }, desc = "AI: Scroll Down" },
            { "<leader>om", function() require("opencode").command("agent.cycle") end, desc = "AI: Cycle Model" },
        },
        dependencies = {
            { "folke/snacks.nvim",
                opts = {
